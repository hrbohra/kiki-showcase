...
const SCREENS = [
  ...
  },
  {
    ...
    standfirst: 'Out for offers, coming up, and — the part no booking app shows — the guest-book entry you still owe. Closing that loop is what keeps the network warm.',
    left: [
